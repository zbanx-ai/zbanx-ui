...
import { useIsMobile } from "@/registry/zbanx/hooks/use-mobile";
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: sidebar state cookie must be written client-side and read by the server layout; Cookie Store API is async and not universally available
