  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground data-[variant=line]:rounded-none group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col",
  {
    variants: {
      variant: {
        ...
        fullWidth:
          "sticky top-0 z-10 h-auto w-full justify-stretch overflow-x-auto overflow-y-hidden rounded-xl border bg-muted/30 p-1.5 shadow-sm [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=fullWidth]/tabs-list:bg-transparent group-data-[variant=line]/tabs-list:bg-transparent group-data-[variant=fullWidth]/tabs-list:data-active:bg-transparent group-data-[variant=line]/tabs-list:data-active:bg-transparent dark:group-data-[variant=fullWidth]/tabs-list:data-active:border-transparent dark:group-data-[variant=line]/tabs-list:data-active:border-transparent dark:group-data-[variant=fullWidth]/tabs-list:data-active:bg-transparent dark:group-data-[variant=line]/tabs-list:data-active:bg-transparent",
