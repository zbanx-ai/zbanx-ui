...
import {
  ...
  CommandList,
  CommandSeparator,
} from "@/registry/zbanx/ui/command";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  DropdownMenuTrigger,
} from "@/registry/zbanx/ui/dropdown-menu";
import {
  HoverCard,
  HoverCardContent,
  HoverCardTrigger,
} from "@/registry/zbanx/ui/hover-card";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
...
export const PromptInputActionAddScreenshot = ({
  ...
  const handleSelect = useCallback(
    async (event: { preventDefault(): void; defaultPrevented: boolean }) => {
      (
        onSelect as
          | ((e: { preventDefault(): void; defaultPrevented: boolean }) => void)
          | undefined
      )?.(event);
...
export const PromptInputSubmit = ({
  ...
  const handleClick = useCallback(
    (e: { preventDefault(): void }) => {
      ...
      (onClick as ((e: { preventDefault(): void }) => void) | undefined)?.(e);
    },
